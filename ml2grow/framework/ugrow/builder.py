...
from umongo.builder import BaseBuilder, _collect_indexes, on_need_add_id_field, data_proxy_factory, add_child_field, _build_document_opts, Schema, _collect_schema_attrs, DocumentTemplate
...
class DataStoreBuilder(BaseBuilder):
    ...
    @staticmethod
    def _convert_reference_field(schema_fields):
        fields = {}
    ...
    def build_document_from_template(self, template):
        ...
        schema_fields = self._convert_reference_field(schema_fields)
        nmspc['opts'] = opts
